...
public class FirebaseHelper {
    ...
    private final static String FIREBASE_URL = "http://android-chat-example.firebaseio.com";
    ...
    public Firebase getOneContactReference(String mainEmail, String chilEmail){
        String childKey = chilEmail.replace(".","_");
